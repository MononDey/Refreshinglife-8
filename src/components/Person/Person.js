...
const Person = () => {
    return (
        <div className='mt-4 flex flex-col items-center text-black tex-center'>
            ...
            <h3 className="mt-1 text-xl font-semibold"> Monon Kanti Dey</h3>
            <h4 className='text-sm'><i className="fa-regular fa-envelope text-violet-700"></i> : mononkanti@gmail.com</h4>
